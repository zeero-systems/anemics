import type { BuilderInterface, JoinClauseInterface, PredicateClauseInterface, TableClauseInterface } from '~/querier/interfaces.ts';
...
import Table from '~/querier/clauses/postgres/table.clause.ts';
